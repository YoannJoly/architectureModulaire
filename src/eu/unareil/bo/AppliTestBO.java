...
public class AppliTestBO {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Stylo styloPapier = new Stylo("Bic", "Evolution original - la Cerisaie", 10000, 1.50f, "gris", "crayon à "
                    + "papier");
            ...
            CartePostale uneCarte = new CartePostale("Carte Sud Bretagne", "La mine d'Or", 10000, 0.80f,
                    lesAuteursDeLaCarte, TypeCartePostale.Paysage);
            ...
            CartePostale uneDeuxiemeCarte = new CartePostale("Carte Sud Bretagne", "Penestin", 10000, 0.80f,
                    lesAuteursDeLaCarteDeux, TypeCartePostale.Paysage);
            ...
            CartePostale uneTroisiemeCarte = new CartePostale("Carte Sud Bretagne", "Guérande", 10000, 0.80f,
                    lesAuteursDeLaCarte, TypeCartePostale.Paysage);
